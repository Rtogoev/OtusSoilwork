...
public class NetworkService {
    ...
    public String receive(ServerSocketChannel serverSocketChannel) throws IOException, InterruptedException {
    ...
    private String read(SelectionKey selectionKey) throws IOException {
    ...
    public void send(ServerSocketChannel serverSocketChannel, String message) throws IOException {
...
//            serverSocketChannel.register(selector, SelectionKey.OP_ACCEPT);
//            System.out.println("send " + selector.keys());
////            if (selector.select() > 0) { // вот тут блокировака, потому что нет коннектов
//                Iterator<SelectionKey> keys = selector.selectedKeys().iterator();
